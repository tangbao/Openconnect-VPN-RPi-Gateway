...
# Duo HOTP CLI tool
#
# Modified. Based on https://gist.github.com/fifty-six/80fa6f9d18952ec21253fc10d1c9d548
...
class HOTP:
    FILE = join(abspath(dirname(__file__)), "secrets.json")
...
def activate_device(activation_url):
    ...
    res = json.loads(post(activation_url).text)
